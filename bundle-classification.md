...
- `gateway/ai/social_capability/github_fit.py` -> INTERNAL — LED-5346 shared GitHub outreach-fit classifier (outreach tooling; imports internal ai.social)
- `gateway/ai/github_qualification.py` -> INTERNAL — LED-5346 cold-outreach qualification cache and run budget (outreach tooling)
...
- `gateway/ai/build_campaign.py` -> INTERNAL — build-loop daemon campaign admission (CMP-20260916b; autonomous control plane)
