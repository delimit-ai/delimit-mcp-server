...
try:
    if transcript_path and Path(transcript_path).exists():
        ...
        for raw in tail:
            ...
            role = (msg or {}).get("role", "") if isinstance(msg, dict) else obj.get("type", "")
            content = (msg or {}).get("content") if isinstance(msg, dict) else obj.get("content")
            texts = []
